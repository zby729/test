...
public class AddTypendController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int typeid = Integer.parseInt(request.getParameter("add_typeid"));
		int flag = new CategoryService().addTypend(typename, typeid);

...
public class UpTypestController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int id = Integer.parseInt(request.getParameter("up_typest_id"));
		CategoryService service = new CategoryService();
		int flag = service.updateCategoryFirstById(typename, id);

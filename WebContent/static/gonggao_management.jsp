<%@page import="com.legou.modules.message.entity.GongGao"%>
<%@page import="java.util.ArrayList"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.legou.modules.user.entity.User" %>
<%@ page import="com.legou.modules.sys.entity.Admin" %>
<%@ page import="com.legou.modules.message.entity.*" %>
<%@ page import="java.util.*" %>
<%
	String path = request.getContextPath();

	ArrayList<GongGao> list = (ArrayList<GongGao>)session.getAttribute("gonggaolist");
	session.removeAttribute("gonggaolist");
...
<html>
	<head>
		...
		<link rel="stylesheet" href="admincss/gonggao_management.css" />
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="contenter-wrap">
											...
											<input type="hidden" class="pages" value="<%=size %>">
												...
												<table id="sample-table-1" class="table table-striped table-hover ">
													...
													%>
														<tr id="tr<%=i%>"> 
															...
															<td>
																<div class="button">
																	<button class="btton look-btn" data-toggle="modal" data-target="#myModal" id="<%=g.getId()%>" 
																	title="<%=g.getTitle() %>" content="<%=g.getContent() %>"  time="<%=g.getTime()%>" onclick="look(this)">修改</button>
																	<button class="btton remove-btn" id="<%=g.getId()%>" onclick="delet(this)">删除</button>
																</div>
															</td>
														</tr>
													<%} %>
											...
											<form action="<%=path %>/delet_gonggao_admin" name="delfrm" method="post">
												...
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form role="form" name="cfrm" action="<%=path%>/gonggao_update_admin" method="post">
																<div class="from-group">
																	<label class="control-label"><h5>公告标题</h5></label>
																	<input class="form-control" name="ctitle">
																</div>
																<div class="from-group">
																	<label class="control-label"><h5>公告内容</h5></label>
																	<textarea class="form-control" rows="2s" cols="10" name="ccontent"></textarea>
																</div>
																<!-- <div class="from-group">
																	<label class="control-label"><h5>公告时间</h5></label>
																	<textarea class="form-control" rows="2" cols="10" name="ctime"></textarea>
																</div> -->
														...
														<div class="modal-footer">
															...
															<button type="button" class="btn btn-xiugai" data-dismiss="modal" onclick="update(this)">修改</button>
														</div>
													</div>
													<!-- /.modal-content -->
												</div>
											...
											<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<div class="modal-body">
															<form role="form" name="addfrm" action="<%=path%>/gonggao_insert_admin" method="post">
																<div class="from-group">
																	<label class="control-label"><h5>公告标题</h5></label>
																	<input class="form-control" required="required" name="gg-title" id="gg-title" type="txet" placeholder="公告标题">
																</div>
																<div class="from-group">
																	<label class="control-label"><h5>公告内容</h5></label>
																	<textarea class="form-control" rows="2s" cols="10" required="required" name="gg-content"></textarea>
																</div>
																<!-- <div class="from-group">
																	<label class="control-label"><h5>公告时间</h5></label>
																	<textarea class="form-control" rows="2" cols="10" required="required" name="gg-time"></textarea>
																</div> -->
																
															</form>
														</div>
														<div class="modal-footer">
															<button type="button" class="btn btn-save" onclick="addgonggao(this)">确定</button>
															<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
														</div>
													</div>
													<!-- /.modal-content -->
...
<![endif]-->
	...
	<script type="text/javascript" src="adminjs/gonggao_management.js"></script> 

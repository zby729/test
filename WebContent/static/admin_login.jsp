...
<html>
	...
	<div id="header">
		...
		<div id="main" style="background-image:url(img/login.jpg);">
			<div class="login-content">
			<form name="frm" action="<%=path%>/adminlogin" method="post">
				...
				<div class="login-wrap">
		           ...
		           <div class="tips">
		            <!-- <div class="password-control">
						<input type="checkbox" id="remember" class="" checked/>
	...
	var url="<%=path%>/checkadminname?name="+frm.username.value;
	...
	var url="<%=path%>/checkadminpwd?username="+frm.username.value+"&password="+frm.password.value;

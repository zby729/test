									...
									<div class="col-xs-12">
										<div class="contenter-wrap">
											<div class="add-button">
												...
												<div class="search">
													<form action="<%=path%>/liketypest" method="post" name="likefrm">
											...
											<div class="table-responsive">
												<table id="sample-table-1" class="table table-striped table-hover ">
													...
													<tbody>
													<input type="hidden" id="item_nums" value="<%=categoryfirstlist.size() %>">
													<%
														for (int i=0; i<categoryfirstlist.size(); i++){
															...
															<tr id="tr<%=i %>">
																<td><%=i+1 %></td>
																<td><%="2" %></td>
																<td><%=categoryfirstlist.get(i).getTypename() %></td>
																<td>
																<div class="button">
																	<button class="btton look-btn" data-toggle="modal" data-target="#myModal" id=<%=categoryfirstlist.get(i).getId() %> typename=<%=categoryfirstlist.get(i).getTypename() %> onclick="editInfo(this)">查看</button>
																	<button class="btton remove-btn" id="del_btn" userId=<%=categoryfirstlist.get(i).getId() %> onclick="delUser(this)">删除</button>
																</div>
															</td>
															</tr>
															<%
											...
											<form action="<%=path %>/deltypest" name="delfrm" method="post">
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															...
															<h4 class="modal-title" id="myModalLabel">商品一级信息</h4>
														</div>
														<div class="modal-body">
															<form role="form" name="frm2" action="<%=path %>/uptypest" method="post">
																<div class="from-group">
																	<label class="control-label"><h5>商品一级别名</h5></label>
																	<input type="hidden" name="up_typest_id" id="up_typest_id">
											...
											<div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
															<h4 class="modal-title" id="myModalLabel">商品一级添加</h4>
														</div>
														<div class="modal-body">
															<form role="form" name="addfrm" action="<%=path%>/addtypest" method="post">
																<div class="from-group">
																	<label class="control-label"><h5>商品一级别名</h5></label>
																	<input class="form-control " id="add_typename" name="add_typename">
																</div>

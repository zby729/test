...
<html>
	<head>
		...
		<link rel="stylesheet" href="admincss/logo_management.css" />
												...
												<table id="sample-table-1" class="table table-striped table-hover ">
													...
													<tbody>
														<tr>
															...
															<td>
																<div class="button">
																	<button class="btton look-btn" data-toggle="modal" data-target="#myModal">修改</button>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															...
															<h4 class="modal-title" id="myModalLabel">logo信息</h4>
														</div>
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<form role="form">
																<div class="from-group">
																	<label class="control-label"><h5>图片路径</h5></label>
																	<input class="form-control " required="required" name="pho-path" id="pho-path" type="txet" >
																</div>
																<div class="from-group">
																	<label class="control-label"><h5>广告作用的URL</h5></label>
...
<![endif]-->
	...
	<script type="text/javascript" src="adminjs/logo_management.js"></script> 
</html>
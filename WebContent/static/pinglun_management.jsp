<%@page import="com.legou.modules.message.entity.Pinglun"%>
...
<%
	...
	pinglunlist = (ArrayList<Pinglun>)session.getAttribute("pinglunlist");
...
<html>
	<head>
		...
		<link rel="stylesheet" href="admincss/pinglun_management.css" />
	...
	<body>
		...
		<div class="main-container" id="main-container">
									...
									<div class="col-xs-12">
										<div class="contenter-wrap">
											<div class="add-button">
												<div class="search">
												<form action="<%=path%>/likepinglun" method="post" name="likefrm">
											...
											<div class="table-responsive">
												<table id="sample-table-1" class="table table-striped table-hover ">
													...
													<tbody>
														<input type="hidden" id="item_nums" value="<%=pinglunlist.size() %>">
														<%
															...
															<%
																for (int j=0 ;j<userlist.size(); j++){
																	if (userlist.get(j).getId() == pinglunlist.get(i).getUserId()){
																		%>
															...
															<%
																for (int k=0; k<commoditylist.size(); k++){
																	if (commoditylist.get(k).getId() == pinglunlist.get(i).getSpId()){
																		%>
																		<%=commoditylist.get(k).getMingcheng() %>
																		<%
																	}
																}
															%>
															</td>
															<td><%=pinglunlist.get(i).getTitle() %></td>
															<td><%=pinglunlist.get(i).getContent() %></td>
															<td><%=pinglunlist.get(i).getTime() %></td>
															<td>
																<div class="button">
																	<button class="btton remove-btn" id="del_btn" userId=<%=pinglunlist.get(i).getId() %> onclick="delUser(this)">删除</button>
																</div>
															</td>
														</tr>
																<%
			...
			<!-- /.modal -->
											...
											<form action="<%=path %>/delpinglun" name="delfrm" method="post">
													...
													<div class="modal-content">
														...
														<div class="modal-body">
															<form role="form">
																...
																<div class="from-group">
																	<label class="control-label"><h5>商品编号</h5></label>
																	<input class="form-control " >
																</div>
																<div class="from-group">
																	<label class="control-label"><h5>评论标题</h5></label>
																	<textarea class="form-control" rows="0" cols="2"> </textarea>
																</div>
																<div class="from-group">
																	<label class="control-label"><h5>评论内容</h5></label>
																	<textarea class="form-control" rows="0" cols="2"> </textarea>
																</div>
																<div class="from-group">
															<label class="control-label"><h5>评论时间</h5></label>
																	<input class="form-control " >
																</div>
														...
														<div class="modal-footer">
															...
															<button type="button" class="btn btn-xiugai" data-dismiss="modal">修改</button>
														</div>
													</div>
													<!-- /.modal-content -->
												</div>
...
<![endif]-->
	...
	<script type="text/javascript" src="adminjs/pinglun_management.js"></script> 

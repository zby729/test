...
var i,
	...
	// http://www.w3.org/TR/CSS21/syndata.jsp#value-def-identifier
	identifier = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+",
	...
	// CSS escapes
	// http://www.w3.org/TR/CSS21/syndata.jsp#escaped-characters
	...
	for ( ; i < l; i++ ) {
		...
		if ( elem || elem === 0 ) {
			...
			// Convert html into DOM nodes
				...
				tmp.innerHTML = wrap[ 1 ] + jQuery.jspPrefilter( elem ) + wrap[ 2 ];
...
jQuery.each( [
	...
	// https://html.spec.whatwg.org/multipage/infrastructure.jsp#strip-and-collapse-whitespace
